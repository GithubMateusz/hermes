...
def get_name_and_url(
    registry: Registry,
) -> tuple[str | Literal[False] | None, str | None]:
...
def iter_databases(
    registry: Registry,
) -> Generator[tuple[str | None | bool, Database, "sqlalchemy.MetaData"], None, None]:
    name, url = get_name_and_url(registry)
    if name is False:
...
def do_run_migrations(
    connection: Any, name: str, metadata: "sqlalchemy.MetaData"
) -> Any:
